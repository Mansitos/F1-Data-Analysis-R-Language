...
```
```{r, out.width = "1440px",echo=FALSE,fig.align='center'}
...
```{r,include = TRUE, warning=FALSE,message=FALSE, echo=!knit_relazione,fig.width=10, fig.height=6}
...
```{r,include = TRUE, warning=FALSE,message=FALSE, echo=!knit_relazione}
...
```{r,include = TRUE, warning=FALSE,echo=!knit_relazione,message=FALSE,fig.width=10, fig.height=6}
...
```{r,include = TRUE, warning=FALSE,echo=!knit_relazione,message=FALSE,fig.width=10, fig.height=5}
